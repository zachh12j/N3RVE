...
class Category3: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //
        lblQuestion.font = UIFont(name: "Futura", size:12)
    ...
    @IBAction func fromCategory3ToCategories(_ sender: Any) {
        self.performSegue(withIdentifier: "fromCategory3ToCategories", sender: self)
        buttonClickSound()
    }
    ...
    func loadNextQuestion() {
        ...
        if(currentQuestionPos + 1 < questions.count) {
            ...
            performSegue(withIdentifier: "fromCategory3ToResults", sender: nil)
        }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if(segue.identifier == "fromCategory3ToResults") {
