...
class Category2: UIViewController {
    ...
    @IBAction func fromCategory2ToCategories(_ sender: Any) {
        self.performSegue(withIdentifier: "fromCategory2ToCategories", sender: self)
        buttonClickSound()
    }
    ...
    func loadNextQuestion() {
        ...
        if(currentQuestionPos + 1 < questions.count) {
            ...
            performSegue(withIdentifier: "fromCategory2ToResults", sender: nil)
        }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if(segue.identifier == "fromCategory2ToResults") {
